...
<html>
 <head>
  ...
  <body>
    <div class="x-body">
        <form action="/power/addRole" method="post" class="layui-form layui-form-pane" id="form1">
                ...
                <div class="layui-form-item">
                <button class="layui-btn" lay-submit="" lay-filter="add" id="add" onclick="closeAll()">增加</button>
              </div>
            </form>
    </div>
